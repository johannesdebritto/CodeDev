    ...
    return (
        <div className="text-center p-6 bg-white text-black">
          ...
          <div className="flex justify-center gap-6 mb-8 py-5">
            <img src="images/icon/logo_flutter.svg" alt="Flutter" className="w-20 h-20" />
            <img src="images/icon/logo_firebase.svg" alt="Firebase" className="w-20 h-20" />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center">
              <img
                ...
                className="w-[130px] h-[130px] mb-2"
              />
              <p className="text-sm font-medium">Apikasi Kesehatan</p>
            </div>
