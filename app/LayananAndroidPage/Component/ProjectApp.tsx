    ...
    <section id="portfolio" className="scroll-offset bg-white max-w-7xl mx-auto px-4 py-12" aria-labelledby="portfolio-heading">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {projects.map((project, index) => (
          <article key={project.id} className="border rounded-lg shadow-md flex flex-col items-start w-full max-w-xs mx-auto" aria-label={`Proyek ${project.title}`}>
            {/* Gambar Proyek */}
            <Image
              src={project.image}
            ...
            <div className="px-4 py-6">
              ...
              <span className="px-3 py-1 text-sm bg-blue-100 text-blue-600 rounded-full mb-4">{project.category}</span>
              ...
              <a
                ...
                aria-label={`Lihat studi kasus proyek ${project.title}`}
              >
      ...
      <div className="mt-8 text-center">
        <a
          ...
          aria-label="Lihat project lainnya"
        >
