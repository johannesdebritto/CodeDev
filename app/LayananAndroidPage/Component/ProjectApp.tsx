...
const projects = [
  {
    ...
    image: '/images/icondekstop/bgungu.png', // Path to image in the public folder
  },
  {
    id: 2,
    title: 'Porto2',
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="px-4 py-6">
              ...
              {/* button */}
              <a href="#_" className="relative inline-flex items-center justify-center p-4 px-3 py-1 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500">
