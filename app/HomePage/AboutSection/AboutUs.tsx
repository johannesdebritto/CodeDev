...
const AboutUs: React.FC = () => {
  return (
    <section id="tentangkami" className="bg-white py-10 px-5 sm:px-16">
      <article className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-12 gap-8 items-center">
        {/* Gambar */}
        <div className="sm:col-span-5 flex justify-start">
          <Image
            ...
            priority // Gambar yang penting untuk SEO diberi priority
          />
        </div>
        ...
        <div className="sm:col-span-7 space-y-4">
          ...
          <p className="text-gray-700 leading-relaxed text-justify text-xl">
            Code<span className="text-blue-600">Dev</span> adalah mitra terpercaya untuk solusi digital Anda. Kami berkomitmen menghadirkan layanan yang tidak hanya berkualitas tetapi juga dirancang khusus untuk memenuhi kebutuhan bisnis
            Anda. Dengan pengalaman dan teknologi terkini, kami memastikan setiap proyek berjalan tepat waktu dan memberikan hasil yang maksimal.
          </p>
        </div>
      </article>
    </section>
