...
const Saran = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen flex items-center justify-center">
      ...
      <div className="max-w-2xl mx-auto mt-10 bg-white shadow-md rounded-lg p-6 relative z-10 min-h-[400px] flex flex-col justify-between">
        {/* Progress Bar */}
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex items-center">
              ...
              {index < steps.length - 1 && (
                <div
                  className={`h-1 w-20 ${
                    currentStep > step ? "bg-blue-300" : "bg-gray-300"
                  }`}
                ></div>
              )}
            </div>
        ...
        {currentStep === 1 && (
          <div>
            ...
            <p className="text-gray-500 mb-6">
              Silakan isi informasi kontak Anda di bawah ini.
            </p>
        ...
        {currentStep === 2 && (
          <div>
            ...
            <p className="text-gray-500 mb-6">
              Masukkan saran atau masukan Anda di sini.
            </p>
            <textarea
              rows={5}
